    ...
    <div class="content">
        ...
        <div class="layout">
            <div class="layout-side" style="height: 800px;">
                <RegionStationCheckBox @CheckedChange="CheckedChange"
                                       ref="regionStationCheckBoxObj"></RegionStationCheckBox>
            </div>
                                        ...
                                        <div class="table-box">
                                            <el-table :data="tableWeek">
                                                ...
                                                <el-table-column prop="fk_waterLevelNow" label="水质目标"
                                                                 :formatter="waterLevel"></el-table-column>
                                                <el-table-column prop="" label="超标因子（倍数）"
...
<script>
    ...
    import RegionStationCheckBox from '../../../common/unit/RegionStationCheckBox'
    ...
    export default {
        ...
        data() {
            return {
                ...
                value_time3: '',
                stationIds: null,
                dic: {"1": "PH", "2": "水温", "3": "溶解氧", "4": "高猛酸盐指数"}, pickerOptions: {
                    shortcuts: [{
                        text: '最近一周',
                        onClick(picker) {
                            const end = new Date();
        ...
        methods: {
            ...
            formatFactor(row, column) {
                var str = "";
                if (row.fk_pollutantId1 != '' && row.fk_pollutantId1 != null) {
                    str = str + this.dic[row.fk_pollutantId1] + "(" + row.pollutant1Over + ")"
                }
                if (row.fk_pollutantId2 != '' && row.fk_pollutantId2 != null) {
                    str = str + this.dic[row.fk_pollutantId2] + "(" + row.pollutant2Over + ")"
                }
                if (row.fk_pollutantId3 != '' && row.fk_pollutantId3 != null) {
                    str = str + this.dic[row.fk_pollutantId3] + "(" + row.pollutant3Over + ")"
                }
                return str;
            },
            initPage() {
            ...
            handleCurrentChange() {
                ...
                var _this = this;
                var url = "/api/report/getMultipleReportWeekData";
                var param = new URLSearchParams();
                ...
                param.append("stationIds", _this.stationIds == null ? '' : _this.stationIds);
                ...
                var _this = this;
                var url = "/api/report/getMultipleReportMonthData";
                var param = new URLSearchParams();
                ...
                var _this = this;
                var url = "/api/report/getMultipleReportYearData";
                var param = new URLSearchParams();
                param.append("pageNum", _this.$refs.paginationObjWeek.cur_page);
                param.append("pageSize", _this.$refs.paginationObjWeek.cur_pageSize);
                param.append("yearTime", _this.value_time3 == null ? '' : _this.value_time2);
                param.append("stationIds", _this.stationIds == null ? '' : _this.stationIds);
                _this.$axios.post(url, param).then(function (response) {
            ...
            mfgChangeYear(pollutants) {
                ...
                var url = "/api/report/exportMultipleReportWeekData";
                var param = new URLSearchParams();
                param.append("pageNum", _this.$refs.paginationObjWeek.cur_page);
                param.append("pageSize", _this.$refs.paginationObjWeek.cur_pageSize);
                param.append("weakTime", document.querySelector("#week").value);
            ...
            exportDataMonth() {
                ...
                var url = "/api/report/exportMultipleReportMonthData";
                var param = new URLSearchParams();
                param.append("pageNum", _this.$refs.paginationObjWeek.cur_page);
                param.append("pageSize", _this.$refs.paginationObjWeek.cur_pageSize);
                param.append("weakTime", document.querySelector("#week").value);
            ...
            exportDataYear() {
                ...
                var url = "/api/report/exportMultipleReportYearData";
                var param = new URLSearchParams();
                param.append("pageNum", _this.$refs.paginationObjWeek.cur_page);
                param.append("pageSize", _this.$refs.paginationObjWeek.cur_pageSize);
                param.append("weakTime", document.querySelector("#week").value);
